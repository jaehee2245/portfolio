export const projectsData = [
  {
    ...
    image: '/assets/0806.mov',
    video: '/assets/0806.mov',
    objectFit: 'contain',
    ...
    caseStudy: {
      ...
      heroImage: '/assets/0806.mov',
      heroVideo: '/assets/0806.mov',
  ...
  },
  {
    ...
    description: 'University life is already chaotic. Why are we managing everything across five different apps?',
    image: '/assets/dip_final_video_2.mp4',
    video: '/assets/dip_final_video_2.mp4',
    objectFit: 'contain',
    visualStyle: 'cloud-bg',
    tags: ['Full-stack Project', 'React Native', 'Supabase', 'PostgreSQL', 'Figma'],
    posterUrl: '/assets/DIP Poster.png',
    caseStudy: {
      tagline: 'Your all-in-one hall events app!',
      heroImage: '/assets/dip_final_video_2.mp4',
      heroVideo: '/assets/dip_final_video_2.mp4',
